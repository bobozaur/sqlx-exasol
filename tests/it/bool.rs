...
test_type_array!(bool_array<bool>::"BOOLEAN"::(vec![true, false], Vec::<bool>::new(), Some(vec![true, false]), [false; 4], &[false; 4], ExaIter::new(&vec![true, false]), ExaIter::new(&HashSet::from([true, false, true]))));
